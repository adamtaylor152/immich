...
class TimelineApi {
  ...
  Future<Response> getTimeBucketWithHttpInfo(String timeBucket, { String? albumId, String? bbox, TimeBucketDateType? dateType, bool? isFavorite, bool? isTrashed, String? key, AssetOrder? order, String? personId, String? slug, bool? suppressedOnly, String? tagId, String? userId, AssetVisibility? visibility, bool? withCoordinates, bool? withPartners, bool? withStacked, }) async {
  ...
  /// * [bool] withStacked:
  ///   Include stacked assets in the response. When true, only primary assets from stacks are returned.
  Future<TimeBucketAssetResponseDto?> getTimeBucket(String timeBucket, { String? albumId, String? bbox, TimeBucketDateType? dateType, bool? isFavorite, bool? isTrashed, String? key, AssetOrder? order, String? personId, String? slug, bool? suppressedOnly, String? tagId, String? userId, AssetVisibility? visibility, bool? withCoordinates, bool? withPartners, bool? withStacked, }) async {
    final response = await getTimeBucketWithHttpInfo(timeBucket,  albumId: albumId, bbox: bbox, dateType: dateType, isFavorite: isFavorite, isTrashed: isTrashed, key: key, order: order, personId: personId, slug: slug, suppressedOnly: suppressedOnly, tagId: tagId, userId: userId, visibility: visibility, withCoordinates: withCoordinates, withPartners: withPartners, withStacked: withStacked, );
  ...
  /// * [bool] withStacked:
  ///   Include stacked assets in the response. When true, only primary assets from stacks are returned.
  Future<Response> getTimeBucketsWithHttpInfo({ String? albumId, String? bbox, TimeBucketDateType? dateType, bool? isFavorite, bool? isTrashed, String? key, AssetOrder? order, String? personId, String? slug, bool? suppressedOnly, String? tagId, String? userId, AssetVisibility? visibility, bool? withCoordinates, bool? withPartners, bool? withStacked, }) async {
    // ignore: prefer_const_declarations
  ...
  /// * [bool] withStacked:
  ///   Include stacked assets in the response. When true, only primary assets from stacks are returned.
  Future<List<TimeBucketsResponseDto>?> getTimeBuckets({ String? albumId, String? bbox, TimeBucketDateType? dateType, bool? isFavorite, bool? isTrashed, String? key, AssetOrder? order, String? personId, String? slug, bool? suppressedOnly, String? tagId, String? userId, AssetVisibility? visibility, bool? withCoordinates, bool? withPartners, bool? withStacked, }) async {
    final response = await getTimeBucketsWithHttpInfo( albumId: albumId, bbox: bbox, dateType: dateType, isFavorite: isFavorite, isTrashed: isTrashed, key: key, order: order, personId: personId, slug: slug, suppressedOnly: suppressedOnly, tagId: tagId, userId: userId, visibility: visibility, withCoordinates: withCoordinates, withPartners: withPartners, withStacked: withStacked, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
