...
class AskSearchPlanDtoFilters {
  /// Returns a new [AskSearchPlanDtoFilters] instance.
  AskSearchPlanDtoFilters({
    this.albumIds = const [],
    this.checksum,
    this.city,
    this.country,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AskSearchPlanDtoFilters &&
  ...
  /// Returns a new [AskSearchPlanDtoFilters] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AskSearchPlanDtoFilters? fromJson(dynamic value) {
    upgradeDto(value, "AskSearchPlanDtoFilters");
    if (value is Map) {
      final json = value.cast<String, dynamic>();

      return AskSearchPlanDtoFilters(
  ...
  static List<AskSearchPlanDtoFilters> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AskSearchPlanDtoFilters>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AskSearchPlanDtoFilters.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AskSearchPlanDtoFilters> mapFromJson(dynamic json) {
    final map = <String, AskSearchPlanDtoFilters>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AskSearchPlanDtoFilters.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AskSearchPlanDtoFilters-objects as value to a dart map
  static Map<String, List<AskSearchPlanDtoFilters>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AskSearchPlanDtoFilters>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AskSearchPlanDtoFilters.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
