...
const ADMIN_ROUTES = new Set([
  ...
  'POST media-health/corrupt/scan',
  'POST media-health/dismiss',
  'POST media-health/missing/locate',
  'POST media-health/missing/relink',
  'POST media-health/missing/scan',
